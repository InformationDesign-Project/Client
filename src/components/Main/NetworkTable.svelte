        ...
        <div class='dashboard'>
			...
			<div >
                <div class='tableContent'>
                    <div class='chainName pointer' on:click={() =>{ changeName(data.chain);}}>{data.chain}</div>
